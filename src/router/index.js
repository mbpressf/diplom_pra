...
const routes = [
  ...
  { path: '/org', name: 'organization', component: OrganizationView, meta: { requiresAuth: true } },
  { path: '/org/reports', name: 'org-reports', component: OrgReportsView, meta: { requiresAuth: true } },
  { path: '/org/exports', name: 'org-exports', component: OrgExportsView, meta: { requiresAuth: true } },
